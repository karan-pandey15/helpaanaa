                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <p className="text-lg md:text-xl font-black text-[#1d4e6e]">₹{item.price * item.quantity}</p>
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                <button 
                  ...
                  className="flex-1 max-w-xs bg-[#457b9d] text-white py-4 rounded-2xl font-black text-lg shadow-xl shadow-blue-200 active:scale-95 transition-all flex items-center justify-center gap-2 group italic"
                >
                  PROCEED TO PAY
