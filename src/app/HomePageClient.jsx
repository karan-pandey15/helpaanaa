...
import SeoHighlightSection from "@/components/seo/SeoHighlightSection";
...
export default function HomePageClient() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-8 md:py-16" aria-label="Browse all services">
        <CategoryScreen />
      </section>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 p-8 md:p-14">
            <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-xl w-full">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4">
                Get the{" "}
                <span className="text-yellow-400">Helpaana</span> Home Service
                Booking App
              </h2>

              <p className="text-white/75 text-base md:text-lg mb-7 leading-relaxed font-medium">
                Your trusted service provider app for mehndi artist booking,
                elder care companion service, senior citizen assistance, hospital
                visit helper, and 15+ categories — book in under 30 seconds on
                Android or at helpaana.com.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                >
                  <svg viewBox="0 0 512 512" className="w-8 h-8 flex-shrink-0" aria-hidden="true">
                    <path fill="#A8E063" d="M64 32C46.3 32 32 46.3 32 64v176l220-208L64 32Z"/>
                    <path fill="#0072FF" d="M32 240v208c0 17.7 14.3 32 32 32l188-240L32 240Z"/>
                    <path fill="#FF4B2B" d="M420 224l-68-40-120 56 120 56 68-40c19-11 19-21 0-32Z"/>
                    <path fill="#F7971E" d="M252 280 64 480h188l68-40 68-40-128-120Z"/>
                    <path fill="#0072FF" d="M252 232 64 32l188 0 128 120-128 80Z"/>
                  </svg>
            ...
            <div className="relative flex-shrink-0 flex items-end justify-center pb-4">
              ...
              <div className="relative w-44 h-[340px] md:w-52 md:h-[400px] rounded-[2.5rem] border-[5px] border-white/20 bg-gray-950 shadow-[0_30px_80px_rgba(0,0,0,0.55)] overflow-hidden flex flex-col">
                ...
                <div className="flex-1 bg-gradient-to-b from-[#1e7a8c] to-[#0f4a56] flex flex-col items-center px-3 pt-5 pb-4 gap-3 overflow-hidden">
                  ...
                  <div className="w-full bg-white/15 rounded-xl px-3 py-2 mt-1">
                    <p className="text-white/50 text-[9px]">Search: mehndi, elder care…</p>
                  </div>
              ...
              <div className="absolute -bottom-2 -left-4 md:-left-10 bg-white rounded-2xl shadow-2xl px-4 py-2.5 flex items-center gap-2">
                <span className="text-yellow-400 text-xl leading-none" aria-hidden="true">★</span>
      ...
      <section id="why-helpaana" className="py-12 md:py-20 bg-gray-50/50">
        <div className="max-w-[1280px] mx-auto px-4">
          <h2 className="sr-only">Why choose Helpaana trusted service provider app</h2>
