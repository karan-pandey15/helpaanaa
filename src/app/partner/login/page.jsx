...
function PartnerLoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#1898A5] via-[#137d88] to-[#0d5560] text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-[#F5A623] font-semibold text-sm uppercase tracking-wider mb-2">
                Partner Portal
              </p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4">
                Join Helpaana Today as A Service Partner
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="px-6 py-3 bg-[#F5A623] hover:bg-[#e09520] text-[#0d5560] font-bold rounded-xl transition-colors"
                >
                  Register Now
                </button>
                  <button 
                  ...
                  className="px-6 py-3 bg-[#00bbf9] hover:bg-[#e09520] text-[#0d5560] font-bold rounded-xl transition-colors"
                >
                  Login Now
                </button>
                <button
          ...
          <div className="mb-6 flex items-start gap-3 p-4 md:p-5 bg-green-50 border border-green-200 rounded-xl text-green-800">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm mt-1 text-green-700">
                Thank you for registering as a Helpaana partner. Our team will verify your KYC documents
