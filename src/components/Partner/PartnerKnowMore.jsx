...
export default function PartnerKnowMore({ onRegisterClick }) {
  return (
    <div className="space-y-10">
      {/* How to Register */}
      <section>
        <h2 className="text-xl md:text-2xl font-bold text-[#0d5560] mb-2">
          How to Become a Helpaana Partner
        </h2>
        <p className="text-gray-600 text-sm md:text-base mb-6">
          Follow these simple steps to register, get verified, and start receiving bookings on Helpaana.
        </p>
        ...
        {onRegisterClick && (
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-[#1898A5] hover:bg-[#137d88] text-white font-semibold rounded-xl transition-colors"
          >
            Start Registration
            <ArrowRight size={18} />
          </button>
      ...
      <section>
        ...
        <p className="text-gray-600 text-sm md:text-base mb-6">
          Helpaana supports partners across diverse service and product categories. Select the category
          ...
          {PARTNER_CATEGORIES.map((cat) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <Link
                  href={cat.screen}
                  className="inline-flex items-center gap-1 text-xs font-semibold text-[#1898A5] hover:text-[#137d88]"
                >
                  View category page
                  <ArrowRight size={12} />
                </Link>
      ...
      <section className="bg-[#1898A5]/5 border border-[#1898A5]/20 rounded-2xl p-6 md:p-8">
        <h2 className="text-lg md:text-xl font-bold text-[#0d5560] mb-4 flex items-center gap-2">
