/** Central SEO config for Helpaana — used in metadata, JSON-LD, sitemap, and on-page copy */

export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, '') || 'https://helpaana.com';

export const SITE_NAME = 'Helpaana';
export const SITE_LEGAL_NAME = 'HELPAANA PREMIUM SERVICES';
export const SITE_TAGLINE = 'Trusted Home Service Marketplace';

export const DEFAULT_OG_IMAGE = '/image/logo.png';
...
export const SEO_KEYWORD_PHRASES = [
  {
    ...
    shortDescription:
      'Book verified home professionals in seconds with Helpaana — India’s trusted home service booking app for daily and premium needs.',
    href: '/',
  ...
  },
  {
    ...
    shortDescription:
      'Dedicated senior citizen assistance for mobility, daily routines, and comfort — book trained companions through Helpaana.',
    href: '/pages/Attendant?categoryId=Attendant',
  ...
  },
  {
    ...
    shortDescription:
      'Helpaana is your local service app for Noida & nearby cities — discover, compare, and book trusted providers near you.',
...
export const DEFAULT_DESCRIPTION =
  'Helpaana is India’s home service booking app and trusted service provider app. Book mehndi artist booking, elder care companion service, senior citizen assistance, hospital visit helper, and more on one local service app and home service marketplace.';

export const DEFAULT_TITLE =
  'Helpaana | Home Service Booking App – Mehndi, Elder Care & Hospital Helper';
...
export function buildWebSiteSchema() {
  return {
    ...
    url: SITE_URL,
    name: SITE_NAME,
    alternateName: ['Helpaana Premium Services', 'helpaana.com', SITE_LEGAL_NAME],
...
/** Sitelinks-style navigation for branded "helpaana" searches */
export function buildSiteNavigationSchema() {
  return {
    ...
    description:
      'Top services on Helpaana: home service booking, mehndi artist, elder care, senior assistance, hospital helper, and more.',
...
export function buildFaqSchema() {
  return {
    ...
    mainEntity: SEO_KEYWORD_PHRASES.map((item) => ({
      '@type': 'Question',
      name: `What is Helpaana ${item.title}?`,
      acceptedAnswer: {
        '@type': 'Answer',
